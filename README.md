...
## Installation
This repository requires `photonlib` package that you can download from [here](https://github.com/cider-ml/photonlib).
...
Traditionally, LArTPC experiments have employed [Photon Library (here)](https://github.com/cider-ml/photonlib) for this modeling.
...
* a data file for Photon Library
  * You can train `siren` given a Photon Library data file. Follow the instructions [here](https://github.com/cider-ml/photonlib) and download the photon library file.   
